...
namespace Tutorial.Tutorials
{
    public static class Classes
    {
        ...
        private static void StaticClasses()
        {
            ...
            string details = StaticHuman.GetDetails();

            StaticHuman.FirstName = "Bob";
            StaticHuman.LastName = "Lazar";
            StaticHuman.Age = 55;

            details = StaticHuman.GetDetails();
        ...
        private static void NonStaticClasses()
        {
            ...
            string baseDetails = $"{ben.FirstName} {ben.LastName} of age {ben.Age}";
        ...
        private static void CompanyExample(WorkingPerson employee)
        {
            ...
            string tool = "Employees tool: " + buildersCompany.Employees[0].WorkingTool.Name;
        ...
        private static void Structs()
        {
            ...
            string bothCoords = $"Coords: X: {coords.X}, Y: {coords.Y}";
            Date date = new(12, 3, 2022);
            string wholeDate = date.GetWholeDate();
        }
        ...
        private static void ReferencesAndValues()
        {
            ...
            Console.WriteLine("number: " + number); // You can see that value of the variable in this calling method didn't change, since it was passed by value
            ...
            Console.WriteLine("pos x: " + pos.X); // You can see that value of the variable in this calling method didn't change, since it was passed by value
            ...
            Console.WriteLine("steve age: " + steve.Age); // You can see that value of this object variable did change since it was passed by reference
            ...
            Console.WriteLine("steve age: " + steve.Age);
            ...
            Console.WriteLine("steve 2 age: " + steve2.Age);
            Console.WriteLine("steve 3 age: " + steve3.Age);
        }
        ...
        private static void PracticalExamples()
        {
            ...
            Console.WriteLine("Response status from Google is success: " + response.IsSuccessStatusCode); // Just like person class you can get information out of the object
        }
    }
    ...
    public class Company
    {
        ...
        public void CompanyListEmployeers()
        {
            ...
            Employees.ForEach(employee => Console.WriteLine($"{employee.FirstName} {employee.LastName} - role: {employee.JobName}, salary: {employee.Salary}"));
        }
    }
